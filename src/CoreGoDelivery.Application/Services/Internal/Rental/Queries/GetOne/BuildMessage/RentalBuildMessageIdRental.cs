...
public class RentalBuildMessageIdRental
{
    public readonly IBaseInternalServices _baseInternalServices;
    public readonly IRentalRepository _repositoryRental;

    public RentalBuildMessageIdRental(IBaseInternalServices baseInternalServices, IRentalRepository repositoryRental)
    {
